<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.Master" AutoEventWireup="true" CodeBehind="CustomerSettings.aspx.cs" Inherits="OwlsEat.CustomerSettings" %>
        ...
        <div class="View Account Information" visible="false" runat="server" id="ViewAccountInformation">
            ...
            <div id="CustomerDetails" runat="server">
                ...
                <br />
                 ...
                 <asp:Label runat="server" Text="Current Delivery Address:" ID="lblCurrentDeliveryAddress"></asp:Label><asp:Label runat="server" Text="Delivery Address" ID="lblDeliveryAddress"></asp:Label>
                <br />
                ...
                <asp:Label runat="server" Text="Current Billing Address:" ID="lblCurrentBillingAddress"></asp:Label><asp:Label runat="server" Text="Billing Address" ID="lblBillingAddress"></asp:Label>
                <br />
